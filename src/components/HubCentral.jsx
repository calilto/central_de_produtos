...
const hubData = [
    {
        ...
        tools: [
            ...
            { name: 'Simulador Multi', desc: 'Renda Mensal, CDB Equivalente, Multi-Index, Cenários CDI.', link: '#', status: 'novo', toolId: 'eurostock-relatorio' },
        ]
    },
    {
        id: 'mesa-rv',
    ...
    },
    {
        ...
        tools: [
            { name: 'Calculadora ITCMD', desc: 'Simulador de custos de inventário por estado.', link: '#', status: 'ativo' },
            { name: 'Comparador de Previdência', desc: 'PGBL vs VGBL com simulador de IR.', link: '#', status: 'ativo' },
            { name: 'Setup Offshore', desc: 'Guia e checklist para abertura de PICs.', link: '#', status: 'novo' },
    ...
    },
    {
        ...
        description: 'Crédito corporativo, câmbio e serviços.',
        tools: [
            { name: 'Cotação de Câmbio B2B', desc: 'Spread e simulador de remessas.', link: '#', status: 'ativo' },
            { name: 'Antecipação de Recebíveis', desc: 'Calculadora de deságio para empresas.', link: '#', status: 'ativo' },
            { name: 'Simulador de Dívida', desc: 'Cálculo de parcelas para Capital de Giro.', link: '#', status: 'ativo' },
            { name: 'Simulador Imobiliário', desc: 'Planeje o seu financiamento com seguros e taxas.', link: '#', status: 'novo', toolId: 'simulador-imobiliario' },
                    ...
                    <div className="max-w-[1000px] p-8 lg:p-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                            {displayedTools.map((tool, idx) => (
                                <div
                                    key={idx}
                                    className="group bg-[#15171C] border border-[#1F232B] rounded-[10px] p-5 transition-all duration-300 flex flex-col h-[185px] relative hover:border-[#2D333F]"
                                >
                                    {/* Status Badges */}
