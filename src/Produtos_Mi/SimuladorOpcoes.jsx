...
export default function SimuladorOpcoes({ onClose }) {
  ...
  const calculateReturn = React.useCallback((variation) => {
  ...
  }, [params, selectedStrategy, simulatedCouponsReceived, calculateReturn]);
  ...
  }, [simulatedVariation, params, selectedStrategy, investment, cdiPeriod, simulatedCouponsReceived, calculateReturn]);
